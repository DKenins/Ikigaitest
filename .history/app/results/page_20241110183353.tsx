...
const ResultsPage = () => {
  ...
  const mainCategoryData = [
    { name: "Passion", value: (scores.passion.CreativeArts || 0) + (scores.passion.IntellectualPursuits || 0) + (scores.passion.PhysicalActivities || 0) },
    { name: "Vocation", value: (scores.vocation.ProblemSolving || 0) + (scores.vocation.Leadership || 0) + (scores.vocation.SpecializedKnowledge || 0) },
    { name: "Mission", value: (scores.mission.InterpersonalSkills || 0) + (scores.mission.CommunityBuilding || 0) + (scores.mission.EducationMentorship || 0) + (scores.mission.SocialCauses || 0) },
    { name: "Profession", value: (scores.profession.BusinessEntrepreneurship || 0) + (scores.profession.SpecializedKnowledge || 0) + (scores.profession.Leadership || 0) },
  ];
