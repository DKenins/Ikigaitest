...
const ResultsPage = () => {
  ...
  const subcategoryData = {
    ...
    datasets: [
      {
        data: subcategoryLabels.map(subcategory => scores[dominantCategory][subcategory as Subcategory]),
        backgroundColor: ["#0466c8", "#023e7d", "#001845", "#001233"],
        hoverBackgroundColor: ["#0f85fa", "#4ba3fb", "#87c2fd", "#c3e0fe"],
      },
    ],
    ...
    <div className="min-h-screen flex flex-col items-center bg-gray-50">
      <div className="bg-white p-8 rounded-xl shadow-md max-w-2xl w-full mb-8">
        ...
        <ul className="list-disc list-inside text-gray-600">
          ...
          <li><strong>6-12 Months:</strong> Focus on gaining advanced knowledge or certifications related to {dominantReport.title}. Look for ways to integrate this element into your daily life and consider long-term career shifts.</li>
          <li><strong>1-2 Years:</strong> Work towards mastering {dominantReport.title}, seeking leadership roles or entrepreneurial opportunities. Develop a comprehensive plan to align your career with your Ikigai.</li>
        </ul>
      </div>
